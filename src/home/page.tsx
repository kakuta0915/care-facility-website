...
import HomeSection from "../components/elements/homeSection/homeSection";
...
const Home: React.FC = () => {
  ...
  return (
    <div className={`${styles.topPage} ${globalStyles.styles}`}>
      ...
      <Container>
        <section
          className={`${styles.newsSection} ${useScrollAnimationStyles.fadeInUp}`}
        >
          <h3>お知らせ</h3>
        ...
        <HomeSection
          className={useScrollAnimationStyles.fadeInRight}
          imgSrc={img5}
          title="健進会について"
        ...
        <HomeSection
          className={useScrollAnimationStyles.fadeInLeft}
          imgSrc={img6}
          title="施設のご案内"
